...
<?php $__currentLoopData = $indigena; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indigenas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div style="align-items: center; margin:20%; margin-top:0;margin-bottom:0; background-color:beige;" class="card mb-3">
    ...
    <div class="card-body">
      <h5 style="font-size: 35px" class="card-title"><?php echo e($indigenas->Tema); ?></h5>
      <p style="font-size: 30px" class="card-text"><?php echo e($indigenas->Poblacion); ?></p>
